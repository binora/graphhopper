...
`customizable_ch.disable=true`. See [Customizable CH](./cch.md) for the node-based adapter behavior, admin metric
recustomization endpoint, and v2 edge-state turn-cost support matrix.
